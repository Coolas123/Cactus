...
namespace Cactus.Services.Implementations
{
    public class DonationOptionService : IDonationOptionService
    {
        ...
        public async Task<BaseResponse<DonationOption>> GetLastAsync(int authorId) {
            DonationOption donationOption = await donationOptionRepository.GetLastAsync(authorId);
            if(donationOption == null) {
                return new BaseResponse<DonationOption>
                {
                    Description="Опция не найдена"
